...
def indicator_processing(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Indicator processing", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Indicator processing", container=container)
...
def join_indicator_processing(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None):
    ...
    if phantom.completed(action_names=['get_phase_data', 'get_response_phase_data']):
        
        # call connected block "indicator_processing"
...
def container_url_format(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    container_phase_format(container=container)
...
def container_phase_format(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('container_phase_format() called')
    
    template = """{0}/phases"""

    # parameter list for template variable replacement
    parameters = [
        "container_url_format:formatted_data",
    ]

    phantom.format(container=container, template=template, parameters=parameters, name="container_phase_format")
...
def get_response_phase_data(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    formatted_data_1 = phantom.get_format_data(name='container_phase_format')
...
def check_for_phases(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    matched = phantom.decision(
        ...
        conditions=[
            ["get_response_phase_data:action_result.data.*.response_body.count", "==", 0],
        ])
...
def assign_workbook(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call custom function "ps-playbooks-dev/assign_workbook", returns the custom_function_run_id
    phantom.custom_function(custom_function='ps-playbooks-dev/assign_workbook', parameters=parameters, name='assign_workbook', callback=get_phase_data)
