def assign_workbook(container_id=None, **kwargs):
    ...
    """ This section assigns the workbook based on the tags presented in the container.  The customer and consultant must defined these beforehand.
        Recommended templates are:
            Indentification - Indicator Enrichment = enrich = 65
            Identification - Command and Control = network = 33
            Identification - Execution = host = 30
    """
    ...
    if success:
        ...
        phantom.debug('phantom.add_workbook failed or was not called. API message: {}'.format(message))
